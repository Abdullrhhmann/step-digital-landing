    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <button className="px-8 py-4 bg-accent text-primary-dark text-lg font-bold rounded-lg hover:bg-accent-dark hover:shadow-glow transform hover:scale-105 transition-all duration-300">
              Get Started
            </button>
          </motion.div>
        </div>
