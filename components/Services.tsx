          ...
          {services.map((service, index) => (
            ...
            >
              <motion.div
                ...
                className={`preserve-3d bg-white rounded-2xl p-8 shadow-card hover:shadow-card-hover transition-all duration-300 border border-gray-100 h-full relative overflow-hidden ${
