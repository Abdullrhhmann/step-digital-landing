    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <button className="px-10 py-5 bg-accent text-primary-dark text-xl font-bold rounded-lg hover:bg-accent-dark hover:shadow-glow-lg transform hover:scale-105 transition-all duration-300 mb-12">
              Get Started Now
            </button>
          </motion.div>
